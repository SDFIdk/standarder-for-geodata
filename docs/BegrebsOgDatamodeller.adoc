...
Standarden [.cite]#Unified Modeling Language# (UML) specificerer et modelleringssprog som er defineret af en metamodel og som har en grafisk notation. Med UML kan både de statiske og dynamiske aspekter af en forretning eller et it-system beskrives på en formel måde.
