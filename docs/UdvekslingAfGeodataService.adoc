...
[.bibliographicaldetails]
MIG. _Technical Guidance for the implementation of INSPIRE View Services_. Version 3.11. 4 april 2013. Tilgængelig på: https://inspire.ec.europa.eu/documents/technical-guidance-implementation-inspire-view-services-1[https://inspire.ec.europa.eu/documents/technical-guidance-implementation-inspire-view-services-1,title=Technical Guidance for the implementation of INSPIRE View Services] 
...
[.bibliographicaldetails]
OGC 17-069r3, _OGC API - Features - Part 1: Core_. Version 1.0. 7 oktober 2019.
Tilgængelig på:
