...
[.bibliographicaldetails] 
OGC 20-010, _OGC City Geography Markup Language (CityGML) Part 1: Conceptual Model Standard_. Version 3.0.0. 2. marts 2021. Tilgængelig på:
...
[NOTE]
====
CityGML 1.0-standarden <<citygml100>> og CityGML 2.0-standarden <<citygml200>> trækkes ikke tilbage for nuværende. Dette skyldes, at der findes mange aktive datasæt, der er i overensstemmelse med disse specifikationer.
====
